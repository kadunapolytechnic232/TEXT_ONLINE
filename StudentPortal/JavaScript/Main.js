...
setInterval(()=>{
    document.querySelector('.MCD').style.height=`${screen.height}px`;//MCD
    document.querySelector('.MCD_U').style.height=`${screen.height}px`;//MCD_U
    document.querySelector('.MCD_A').style.height=`${screen.height}px`;//MCD_A

    //
    document.querySelector('.MCD_UB').style.height=`${screen.height-100}px`;//MCD_UB
    document.querySelector('.VR_DB').style.height=`${screen.height-70}px`;//VR_DB
...
setInterval(()=>{
    if(document.querySelector('.CALA_page_Button') != null){
        ...
        document.querySelector('.CALA_page_Button').addEventListener("click",()=>{
            ...
            if(document.querySelector('.IEC').value === "0000"){
